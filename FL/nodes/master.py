import sys
sys.path.append(r'C:\Users\btsma\agnostic_federated_learning')
...
class Fedavg_Global(GlobalBase):
    ...
    def aggregate(self,local_params):
        ...
        w_avg = weighted_average_weights(local_weights, self.model.state_dict())
    ...
    # def save_global_model(self, file_path="global_model.pth"):
    #     """
    #     Saves the global model's state dictionary to the specified file path.
    #     """
